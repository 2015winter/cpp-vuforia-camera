...
//    private LoadTrackerTask mLoadTrackerTask;
    ...
    private native void startNativeCamera();
    private native void stopNativeCamera();
    private native void onVuforiaInitializedNative();
    ...
    public void startAR(int camera) throws SampleApplicationException
    {
        ...
        if (!CameraDevice.getInstance().init(camera))
        {
            ...
            Log.e("myErr", "CameraDevice is init!");
//Modified by winter on 2016-3-29 modify resolution
...
/*        if (!CameraDevice.getInstance().start())
        {
            ...
            Log.e("myErr", "CameraDevice is started!");
*/
        setProjectionMatrix();
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            if (result) {
                ...
                //**************************//
                //capture on android by registerCallback
//                Vuforia.registerCallback(SampleApplicationSession.this);
                //capture on native by registerCallback
...
//    }
    ...
    private String getInitializationErrorString(int code)
    {
        ...
        if (code == Vuforia.INIT_LICENSE_ERROR_MISSING_KEY)
            return "Vuforia App key is missing.";
        ...
        if (code == Vuforia.INIT_LICENSE_ERROR_CANCELED_KEY)
            return "This app license key has been canceled and may no longer be used.";
        if (code == Vuforia.INIT_LICENSE_ERROR_PRODUCT_TYPE_MISMATCH)
            return "Vuforia App key is not valid for this product.";
        else
        {
            return "";
        }
